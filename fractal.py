...
WIDTH = 800
HEIGHT = 600
TITLE = "Fractal: Sierpinski Triangle"
...
while not done:
    ...
    for i in range(0, 100000):
        ...
        if(k == 1):
            start_x4 = (start_x1+start_x4)/2
            start_y4 = (start_y1+start_y4)/2
            end_x4 = (end_x1+end_x4)/2
            end_y4 = (end_y1+end_y4)/2
        if(k == 2):
            start_x4 = (start_x2 + start_x4) / 2
            start_y4 = (start_y2 + start_y4) / 2
            end_x4 = (end_x2 + end_x4) / 2
            end_y4 = (end_y2 + end_y4) / 2
        if(k == 3):
            start_x4 = (start_x3 + start_x4) / 2
            start_y4 = (start_y3 + start_y4) / 2
            end_x4 = (end_x3 + end_x4) / 2
            end_y4 = (end_y3 + end_y4) / 2
